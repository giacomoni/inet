...
class INET_API TestProtocolUsingAccessor : public cSimpleModule, public QueueAccessor::ICallback
{
  protected:
  ...
  protected:
    virtual ~TestProtocolUsingAccessor() { cancelEvent(&timer); delete packet; }
...
#endif // ifndef __INET_TESTPROTOCOLUSINGACCESSOR_H
